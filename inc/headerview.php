...
<head>
    ...
    <title>SkyFall Bank <?php echo $title ?></title>
    <!-- Bootstrap CSS -->
    ...
    <!--Header-->
        <nav class="navbar navbar-expand-md navbar-light bg-dark shadow">
            <a href="#" class="navbar-brand">
                <img src="pixs/SKYFALL.png" height="40" width="200" alt="CoolBrand">
            </a>
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarCollapse">
                <div class="navbar-nav align-right">
                    ...
                    <a href="transactions.php" class="nav-item nav-link text-white"><i class="fa fa-address-card"></i> Transactions</a>           
                </div>               
            </div>
        </nav>
